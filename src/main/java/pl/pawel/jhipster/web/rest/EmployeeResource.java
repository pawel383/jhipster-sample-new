...
import pl.pawel.jhipster.domain.Employee;
import pl.pawel.jhipster.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link pl.pawel.jhipster.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
